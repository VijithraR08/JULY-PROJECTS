...
public class Bookingcomdatepicker {
	...
	public void test() {
		...
		datePickerMethod("November 2023","29");
	...
	private void datePickerMethod(String expmonth, String expdate) 
	{
       while (true)
       {
		  ...
		  { 
			driver.findElement(By.xpath("//*[@class='a83ed08757 c21c56c305 f38b6daa18 d691166b09 f671049264 deab83296e f4552b6561 dc72a8413c f073249358']")).click();
		  }
		}
